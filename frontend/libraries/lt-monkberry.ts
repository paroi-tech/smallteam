...
/**
 * Each function can return an `Element` or an array of `Element`, which will been appended as children to `el`. Or it can return nothing if the function has already done the `el.appendChild`.
 */
