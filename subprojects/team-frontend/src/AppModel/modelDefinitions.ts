import { ModelUpdate } from "@local-packages/shared/dist/Cargo"
import { AccountCreateFragment, AccountIdFragment, AccountSearchFragment, AccountUpdateFragment } from "@local-packages/shared/dist/meta/Account"
import { CommentCreateFragment, CommentIdFragment, CommentUpdateFragment } from "@local-packages/shared/dist/meta/Comment"
import { FlagCreateFragment, FlagIdFragment, FlagUpdateFragment } from "@local-packages/shared/dist/meta/Flag"
import { ProjectCreateFragment, ProjectIdFragment, ProjectSearchFragment, ProjectUpdateFragment } from "@local-packages/shared/dist/meta/Project"
import { StepCreateFragment, StepIdFragment, StepUpdateFragment } from "@local-packages/shared/dist/meta/Step"
import { TaskCreateFragment, TaskIdFragment, TaskSearchFragment, TaskUpdateFragment } from "@local-packages/shared/dist/meta/Task"
